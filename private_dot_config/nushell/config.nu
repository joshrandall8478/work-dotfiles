...
$env.config = {
	...
	# FIXME: The default is 25 but that generated an error.
	...
	keybindings: [
		...
		{
			# Keypad 'Enter' does not act like 'Enter'; instead it acts like Ctrl-J
			#   code: Enter, modifier: KeyModifiers(0x0), flags: 0b000000, kind: Press, state: KeyEventState(0x0)
			#   char: j, code: 0x00006a, modifier: KeyModifiers(CONTROL), flags: 0b000010, kind: Press, state: KeyEventState(0x0)
			#   char: j, code: 0x00006a, modifier: KeyModifiers(CONTROL), flags: 0b000010, kind: Press, state: KeyEventState(0x0)
			name: newline_or_run_command
			modifier: control
			keycode: char_j
